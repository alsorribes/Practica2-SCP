...
public class SharkFishModel extends JComponent implements MouseListener {
	...
	// Simulation time = generation number.
	private int generation;

	// Simulation Statistcs.
	private int fishCnt, sharkCnt, emptyCnt;

	// Duración de ciclo de reproducción de los peces y tiburones
	...
	public void step()
	{
		...
		// Simular comportamiento de todas las celdas no nulas del mapa/oceano.
